...
so its orbit alone has size $645\,120/3=215\,040>19\,866$. What
...
al.'s improved energy lower bound -- the same bound value
$\sum_{v\in U}h(v)=340$ established directly above. Their Hamiltonian is
...
$H\approx-120.2$, or $H/N\approx-0.470$ per site. Their paper reports
the result in energy units only, without an explicit spin configuration
