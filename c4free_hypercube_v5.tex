...
are likewise fully archived: they are computed exhaustively over all
released solutions, not sampled, so they are independently
reproducible from the released edge lists alone. The quantitative
