...
(see Section~\ref{sec:method} for a caveat about reproducing this
process from the released code). It has since been
...
Source & one of 389 SA sols. & witness for~\cite{MPR95} bound\\
